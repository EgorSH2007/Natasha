...
back = (134,138,204)
w1 = GameSprite('jopa.jpg', win_width / 2 - win_width /3, win_height /2, 300, 500)
w2 = GameSprite('jopa.jpg', 370,100,50,400)
hero = Player('anime.png', 5, win_height - 80,80,80,0,0)
enemy = Enemy('EnemyGG_allmode.png',5, win_height - 80,80,80,0)
...
while ruun:
    ...
    for i in event.get():
        if i.type == QUIT:
            ruun = False
    wall_12 = GameSprite('jopas.jpg', 80,180,200,250)
